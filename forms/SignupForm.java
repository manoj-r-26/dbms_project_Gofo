...
public class SignupForm extends JFrame {
    public SignupForm() {
        ...
        JLabel title = new JLabel("📝 Register for GoFo");
        ...
        JComboBox<String> roleBox = new JComboBox<>(new String[]{"Select role", "PLAYER", "OWNER"});
        styleComboBox(roleBox);

        JButton signupBtn = createButton("Register");
        ...
        signupBtn.addActionListener(e -> {
            ...
            if (UserDAO.getInstance().exists(username)) {
            ...
            User user = role == Role.PLAYER
                    ? new Player(0, username, password, 100)
                    : new Owner(0, username, password, 0);

            // ✅ Register owner in OwnerRegistry
            if (role == Role.OWNER) {
